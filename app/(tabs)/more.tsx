...
import { StyleSheet, View, TouchableOpacity, Image, ScrollView, Dimensions, Animated } from 'react-native';
...
const miniGames = [
  {
    ...
    image: 'https://img.freepik.com/free-vector/wheel-fortune-roulette-3d-spinning-lucky-roulette_107791-15837.jpg',
    color: ['#FF9800', '#F57C00'],
  ...
  },
  {
    ...
    image: 'https://img.freepik.com/free-vector/food-matching-game-background_1308-95233.jpg',
    color: ['#4CAF50', '#2E7D32'],
    icon: 'square.grid.2x2'
  },
  {
    id: 'game3',
    title: 'Puzzle Nhà Hàng',
